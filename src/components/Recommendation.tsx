...
const Recommendation: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://api.themoviedb.org/3/movie/123/recommendations', {
          params: {
  ...
  return (
    <div className="movies-container">
      {loading ? ( // Display loading spinner or placeholder if loading is true
...
// import { Movie } from '../MovieInterface'; // Import the Movie interface
// import { RotatingLines } from 'react-loader-spinner';
// import Crew from './Crew'; // Import the Crew component

// const Recommendation: React.FC = () => {
//   const [movies, setMovies] = useState<Movie[]>([]);
//   const [loading, setLoading] = useState(true); // State to manage loading state
//   const [selectedMovie, setSelectedMovie] = useState<Movie | null>(null);
//   const [showCrewPage, setShowCrewPage] = useState(false); // State to manage crew page visibility
...
//   const handleOpenCrewPage = (movie: Movie) => {
//     setSelectedMovie(movie);
//     setShowCrewPage(true);
//   };
...
//             className="card"
//             key={movie.id}
//             onClick={() => handleOpenCrewPage(movie)}
//           >
//             <img 
//               src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`}
//               alt={movie.title}
...
//             <span className="title">{movie.title}</span>
//             <div className="overview">{movie.overview}</div>
//             <div className="rt">Rating: {movie.vote_average}</div>
//             <h5 className="re">Release Date: {movie.release_date}</h5>
//           </div>
//         ))
//       )}
